 ...
 * 
 * DEPRECATED: This handler is kept for backward compatibility but should not be used for MCP operations.
 * MCP operations are now handled by com.blurr.voice.flutter.WorkflowEditorHandler.
 */
class WorkflowEditorHandler(
    ...
    mcpClient: MCPClient? // This parameter is ignored - kept for backward compatibility only
