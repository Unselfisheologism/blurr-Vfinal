...
class ExcelService {
  ...
  void _applyFormatting(dynamic cell, CellFormat format) {
    final cellStyle = cell.cellStyle?.copyWith(
      ...
      fontColorHexVal: excel.ExcelColor.fromHexString(format.textColor ?? '#000000'),
      backgroundColorHexVal: excel.ExcelColor.fromHexString(format.backgroundColor ?? '#00000000'),
      ...
      italic: format.italic,
      underline: format.underline ? excel.Underline.Single : excel.Underline.None,
      fontColorHex: excel.ExcelColor.fromHexString(format.textColor ?? '#000000'),
      backgroundColorHex: excel.ExcelColor.fromHexString(format.backgroundColor ?? '#00000000'),
